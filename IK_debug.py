...
def test_code(test_case):
    ...
    def TF_Matrix(alpha,a,d, q):
        TF = Matrix([[cos(q),               -sin(q),    0,  a],
                     ...
                     [sin(q)*sin(alpha), cos(q)*cos(alpha), cos(alpha), cos(alpha)*d] ,
                     [0        ,0           ,0 ,                    1]
                    ])
        return TF;

    # Transformaion matrixes for each joint transition
    ...
    # extract end-effector position and orientation from the request 
    # px, py 
